        ...
        <header>
            <div>
                <nav aria-label="Main" className="main-nav">
                    <img src={logo} alt="" className="title" width="170" height="170" />
                    <div className="social-media-links_wrapper">
                        <a href="https://twitter.com/ebuka_solomon8" target="_blank" rel="noopener noreferrer">
                        ...
                        <a href="https://web.facebook.com/profile.php?id=100072826898724" target="_blank" rel="noopener noreferrer">
                        ...
                        <a href="https://www.instagram.com/ebuka_hazard/" target="_blank" rel="noopener noreferrer">
